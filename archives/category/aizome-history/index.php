<?php
$basePath = '../../../';
$pageTitle = '藍染の歴史 – 河口湖の草木染め・藍染・染物体験教室インディゴ高菜先生|アパレルオンラインショップ通販';
$canonicalUrl = '';
$bodyClass = 'archive category category-5 custom-background wp-theme-lightning fa_v7_css sidebar-fix sidebar-fix-priority-top bootstrap4 device-pc';
...
<!-- [ .breadSection ] --><div class="section breadSection"><div class="container"><div class="row"><ol class="breadcrumb" itemscope="" itemtype="https://schema.org/BreadcrumbList"><li id="panHome" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a href="../../../" itemprop="item"><span itemprop="name"><i class="fa-solid fa-house"></i> HOME</span></a><meta content="1" itemprop="position"/></li><li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem"><a href="../../../blog" itemprop="item"><span itemprop="name">ブログ</span></a><meta content="2" itemprop="position"/></li><li><span>藍染の歴史</span><meta content="3" itemprop="position"/></li></ol></div></div></div><!-- [ /.breadSection ] -->
<div class="section siteContent">
<div class="container">
<div class="row">
<div class="col mainSection mainSection-col-two baseSection vk_posts-mainSection" id="main" role="main">
<header class="archive-header"><h1 class="archive-header_title">藍染の歴史</h1></header>
<div class="postList">
<article class="media">
...
<li class="cat-item cat-item-5 current-cat"><a aria-current="page" href="../../../archives/category/aizome-history">藍染の歴史</a>
</li>
</ul>
</nav>
</aside>
