<?php
$basePath = '../../';
$pageTitle = '女性モノの服の染め直し – 河口湖の草木染め・藍染・染物体験教室インディゴ高菜先生|アパレルオンラインショップ通販';
$canonicalUrl = '../../archives/878';
$bodyClass = 'wp-singular post-template-default single single-post postid-878 single-format-standard custom-background wp-theme-lightning fa_v7_css sidebar-fix sidebar-fix-priority-top bootstrap4 device-pc';
...
<article class="entry entry-full post-878 post type-post status-publish format-standard has-post-thumbnail hentry category-6" id="post-878">
...
<p>今回のお客様から染め直しの依頼をご紹介させていただきます。</p>
<p> </p>
<h2>カウンセリング内容</h2>
<p>ワンピースのご依頼。</p>
...
<p>今回は、ムラなし濃いめのデザインにしましたので2回染めをしました。</p>
<p>柄入りとは違い藍色の良さが前面にでてくれて、綺麗に染めることが出来ました。</p>
<div class="box-019">
<div>お客様の声</div>
