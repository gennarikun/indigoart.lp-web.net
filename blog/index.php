...
<div class="lp-page-blog">
  ...
  <div>
<div class="lp-blog-layout">
  <div class="lp-blog-main" role="main">
      ...
      <article class="lp-blog-card">
        <a href="../archives/878" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">私たちはシミや色褪せてしまって着なくなってしまった洋服をお客様から依頼を受けて染め直し、また着れる洋服へと生まれ変わらせる「染め直しサービス」を行っています。 今回のお客様から染め直しの依頼をご紹介させていただきます。 […]</p>
          </div>
        </a>
      </article>
      <!-- post 830 -->
      <article class="lp-blog-card">
        <a href="../archives/830" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">私たちはシミや色褪せてしまって着なくなってしまった洋服をお客様から依頼を受けて染め直し、また着れる洋服へと生まれ変わらせる「染め直しサービス」を行っています。 そこで今回お客様から染め直しの依頼を受けたのでご紹介させてい […]</p>
          </div>
        </a>
      </article>
      <!-- post 441 -->
      <article class="lp-blog-card">
        <a href="../archives/441" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">日本における藍染の歴史年表 奈良時代 (710年～794年) 藍染の技術が中国や朝鮮半島から日本に伝わる。貴族間での使用が始まる。 鎌倉時代 (1185年～1333年) 武士階級の台頭とともに、藍染めされた衣服が武士の間 […]</p>
          </div>
        </a>
      </article>
      <!-- post 385 -->
      <article class="lp-blog-card">
        <a href="../archives/385" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">古代アフリカにおける藍染は、地域によって異なる独自の使い方、文化的意義、そして生活への影響を持っていました。藍染は、アフリカ大陸全体、特に西アフリカで広く用いられ、強い文化的アイデンティティの表現として重要な役割を果たし […]</p>
          </div>
        </a>
      </article>
      <!-- post 381 -->
      <article class="lp-blog-card">
        <a href="../archives/381" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">古代中国における藍染は、その使い方、歴史、そして人々の生活に密接に関わっていた複雑な文化的要素を持っています。以下は古代中国における藍染の詳細な分析です。 藍染の使い方と象徴性 衣服: 古代中国では、藍染は広範囲にわたる […]</p>
          </div>
        </a>
      </article>
      <!-- post 378 -->
      <article class="lp-blog-card">
        <a href="../archives/378" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">古代インドにおける藍染は、衣服、芸術、社会生活に深く浸透していました。インドでは、藍染めが特にインディゴフェラという植物から抽出される藍によって行われており、古代から重要な染料として用いられてきました。以下は古代インドに […]</p>
          </div>
        </a>
      </article>
      <!-- post 376 -->
      <article class="lp-blog-card">
        <a href="../archives/376" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">古代エジプトにおける藍染は、衣服、装飾品、そして宗教的儀式に深く関わっていました。エジプト人は色とその象徴性を重視し、藍色は天空や神秘、創造の力を象徴していたとされます。以下は、古代エジプトでの藍染の使い方とその歴史、生 […]</p>
          </div>
        </a>
      </article>
      <!-- post 370 -->
      <article class="lp-blog-card">
        <a href="../archives/370" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">世界における藍染の歴史 藍染は、天然の藍から作られる青い染料を使って布を染める伝統的な技法です。この染色技術は、世界中の多くの文化で古くから用いられてきました。 紀元前2500年 ギリシャのテーベで藍染の使用が確認される […]</p>
          </div>
        </a>
      </article>
      <!-- post 168 -->
      <article class="lp-blog-card">
        <a href="../archives/168" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">藍染めの古の技、山梨県富士河口湖地域での息吹 藍染めは、その神秘的な青が魅了する伝統技術として、古代より日本各地で愛され続けています。特に、山梨県富士河口湖地域は、藍染めの技術が栄え、今に伝えられる重要な場所の一つです。 […]</p>
          </div>
        </a>
      </article>
      <!-- post 166 -->
      <article class="lp-blog-card">
        <a href="../archives/166" class="lp-blog-link">
          ...
          <div class="lp-blog-content">
            ...
            <p class="lp-blog-excerpt">藍染めの魅力が息づく現代デザイン 藍染め、この古くから続く日本の伝統技術は、その美しい青色で多くの人を魅了し続けています。しかし、その魅力は歴史的な価値に留まらず、現代のファッションやインテリアデザインにおいても、新たな […]</p>
          </div>
        </a>
      </article>
    </div> <!-- /grid -->
  ...
  <aside class="lp-blog-sidebar">
    <div class="lp-sidebar-widget">
      <h3 class="lp-sidebar-title">カテゴリー</h3>
      <ul class="lp-sidebar-list">
        <li><a href="../archives/category/somenaoshi-service">染め直しサービス</a></li>
        <li><a href="../archives/category/about-aizome">藍染について</a></li>
        <li><a href="../archives/category/aizome-history">藍染の歴史</a></li>
      </ul>
    </div>
  </aside>
</div>
